        ...
        <GuideReadingLayout contents={contents} path={path}>
          ...
          <section className="guide-section" id="community-feedback">
            ...
            <div>
              ...
              <ul className="guide-checklist">
                <li><strong>Adopt with adaptation:</strong> Rhi’s running review kept the architecture vocabulary, exploration gate, inline context updates, and Design It Twice pattern, while dropping ADR ceremony and TypeScript-specific pieces that did not fit its environment.</li>
                <li><strong>Strongest independent praise:</strong> Kaizen Craft singled out feedback-loop-first diagnosis and the no-op/context-load theory in the earlier writing skill, while warning that much of the wording is self-reported methodology rather than evaluated performance.</li>
                <li><strong>Upstream friction:</strong> GitHub issue #247 reports a 12-hour grilling session; issue #853 reports 40–50 questions, context compaction, and spec drift; issue #797 asks for hypothesis-led confirmation to reduce question count.</li>
                <li><strong>Superpowers comparison is anecdotal:</strong> one Reddit thread reports higher token burn with Superpowers and better edge-case discovery with <code>grill-me</code>; replies recommend taking only one or two useful skills and customizing them.</li>
              </ul>
              <p>
