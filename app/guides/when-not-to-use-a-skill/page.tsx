...
const guidePath = `${basePath}/guides/when-not-to-use-a-skill`;
const guideImagePath = `${basePath}/guides/shai-hulud-worm-ai-software-engineering-risks.jpg`;
const contents = [
      ...
      <article className="guide-article spectrum-guide">
        <div className="spectrum-feature">
          <header className="guide-hero spectrum-hero">
            ...
            <p className="guide-meta">Last reviewed September 3, 2026</p>
          </header>

          <figure className="spectrum-visual">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
              alt="Shai-Hulud worm and AI software engineering risks: a compromised npm package can run install scripts, steal secrets, and propagate to other repositories and packages"
            ...
            />
            <figcaption>
              Shai-Hulud illustrates why a skill that installs dependencies,
              handles credentials, or reaches cloud services deserves a trust-boundary
        ...
        >
          <div className="spectrum-reading">
            <div className="spectrum-intro">
              <p>
                The Shai-Hulud campaign was a coordinated npm supply-chain
                compromise: malicious install-time code stole developer
                credentials and used that access to publish infected versions of
                additional packages. Skills are not npm packages, but the
                incident is a useful warning: a skill can still widen the path
                from instructions to dependencies, credentials, and external
                services.
              </p>
            </div>
